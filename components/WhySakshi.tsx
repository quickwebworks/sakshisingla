        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-16 items-center">
          <div className="lg:col-span-5 reveal">
            <div className="relative max-w-md mx-auto lg:mx-0">
              <div className="aspect-[4/5] rounded-[2.5rem] overflow-hidden shadow-2xl">
                <Image src="https://picsum.photos/seed/sakshi-about-portrait/600/750.jpg" alt="Dietitian Sakshi Singla in her consultation space" width={600} height={750} className="w-full h-full object-cover" />
              </div>
              ...
              <div className="absolute -top-4 -left-3 lg:-left-8 glass-card rounded-2xl px-4 py-3 flex items-center gap-2">
                <div className="flex -space-x-2">
                  <div className="w-7 h-7 rounded-full bg-sage border-2 border-warm-white" />
                  <div className="w-7 h-7 rounded-full bg-peach border-2 border-warm-white" />
                  <div className="w-7 h-7 rounded-full bg-beige border-2 border-warm-white" />
                </div>
                <span className="text-xs text-charcoal-soft font-medium">200+ served</span>
              </div>
            </div>
          </div>
          <div className="lg:col-span-7 reveal delay-2">
            ...
            <div className="flex items-center gap-6 mb-7 pb-7 border-b border-sage/30">
              <div>
                <div className="font-display text-3xl font-medium text-forest leading-none">5+</div>
              ...
              <div>
                <div className="font-display text-3xl font-medium text-forest leading-none">200+</div>
