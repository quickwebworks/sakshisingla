...
export const MYSTERY_STRATEGIES: Record<string, { title: string; subtitle: string; points: string[]; image?: string }> = {
  ...
  pcos: { title: 'PCOS Nutrition', subtitle: 'Nutrition patterns that support insulin sensitivity and hormonal balance.', points: ['Cycle-aware nutrition', 'Blood sugar and cravings support', 'Energy, sleep and stress habits'], image: '/images/PCOS-Nutrition.jpg' },
  diabetes: { title: 'Diabetes Nutrition', subtitle: 'Blood-sugar-aware eating through real food and practical choices.', points: ['Balanced meals for steadier readings', 'Food choices that fit your routine', 'Progress tracking and practical guidance'], image: '/images/Diabetes-Nutrition.jpg' },
  thyroid: { title: 'Thyroid Nutrition', subtitle: 'Nutrition support for Hyper/Hypo conditions, energy and metabolic wellbeing.', points: ['Condition-aware nutrition support', 'Energy and metabolism habits', 'Practical meals for your routine'], image: '/images/Thyroid-Nutrition.jpg' },
  gut: { title: 'Gut & Digestive Health', subtitle: 'Personalised nutrition for better digestion, comfort and regularity.', points: ['Identify food and symptom patterns', 'Comfort-focused meal strategies', 'Support for regularity and routine'], image: '/images/Gut-&-Digestive-Health.jpg' },
  liver: { title: 'Liver Health Nutrition', subtitle: 'Food-first nutrition support for fatty liver and metabolic health.', points: ['Metabolic health support', 'Balanced, liver-friendly meals', 'Sustainable lifestyle changes'], image: '/images/Liver-Health-Nutrition.jpg' },
  heart: { title: 'Heart & Cholesterol Nutrition', subtitle: 'Heart-supportive eating without complicated food rules.', points: ['Heart-supportive food choices', 'Practical cholesterol-aware meals', 'Simple habits for long-term wellbeing'], image: '/images/Heart-&-Cholesterol-Nutrition.jpg' },
  kidney: { title: 'Kidney Nutrition', subtitle: 'Personalised nutrition adapted to kidney function and medical needs.', points: ['Nutrition adapted to your needs', 'Medical-context meal guidance', 'Clear, practical food choices'], image: '/images/Kidney-Nutrition.jpg' },
  'skin-hair': { title: 'Skin & Hair Nutrition', subtitle: 'Nourishment from within to support healthier skin and hair.', points: ['Nutrient-rich meal planning', 'Lifestyle support for healthy growth', 'Personalised guidance for your goals'], image: '/images/Skin-&-Hair-Nutrition.jpg' },
  maternal: { title: 'Maternal Nutrition', subtitle: 'Trimester-wise nourishment for mother and baby — nausea, cravings and aversions covered.', points: ['Trimester-wise nutrition support', 'Practical help for nausea and cravings', 'Nourishment for mother and baby'], image: '/images/Maternal-Nutrition.jpg' },
  paediatric: { title: 'Paediatric Nutrition', subtitle: 'Growth-supporting meals that work even with picky eaters.', points: ['Growth-focused meal planning', 'Picky-eater friendly strategies', 'Family routines that feel achievable'], image: '/images/Paediatric-Nutrition.jpg' },
  sports: { title: 'Sports Nutrition', subtitle: 'Fuelling and recovery strategies matched to your training.', points: ['Training and recovery nutrition', 'Strength-supportive meal planning', 'Hydration and performance habits'], image: '/images/Sports-Nutrition.jpg' },
  midlife: { title: 'Perimenopause & Menopause', subtitle: 'Nutrition for changing metabolism, muscle, bone and appetite through midlife.', points: ['Support for changing metabolism', 'Muscle and bone supportive meals', 'Appetite and energy strategies'], image: '/images/Perimenopause-&-Menopause.jpg' },
};
