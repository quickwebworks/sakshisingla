...
export const MYSTERY_STRATEGIES: Record<string, { title: string; subtitle: string; points: string[]; image?: string }> = {
  ...
  liver: { title: 'Liver Health Nutrition', subtitle: 'Food-first nutrition support for fatty liver and metabolic health.', points: ['Metabolic health support', 'Balanced, liver-friendly meals', 'Sustainable lifestyle changes'], image: 'https://images.unsplash.com/photo-1490645935967-10de6ba17061?auto=format&fit=crop&w=1200&q=85' },
  heart: { title: 'Heart & Cholesterol Nutrition', subtitle: 'Heart-supportive eating without complicated food rules.', points: ['Heart-supportive food choices', 'Practical cholesterol-aware meals', 'Simple habits for long-term wellbeing'], image: 'https://images.unsplash.com/photo-1505751172876-fa1923c5c528?auto=format&fit=crop&w=1200&q=85' },
  kidney: { title: 'Kidney Nutrition', subtitle: 'Personalised nutrition adapted to kidney function and medical needs.', points: ['Nutrition adapted to your needs', 'Medical-context meal guidance', 'Clear, practical food choices'], image: 'https://images.unsplash.com/photo-1498837167922-ddd27525d352?auto=format&fit=crop&w=1200&q=85' },
  'skin-hair': { title: 'Skin & Hair Nutrition', subtitle: 'Nourishment from within to support healthier skin and hair.', points: ['Nutrient-rich meal planning', 'Lifestyle support for healthy growth', 'Personalised guidance for your goals'], image: 'https://images.unsplash.com/photo-1515377905703-c4788e51af15?auto=format&fit=crop&w=1200&q=85' },
  maternal: { title: 'Maternal Nutrition', subtitle: 'Trimester-wise nourishment for mother and baby — nausea, cravings and aversions covered.', points: ['Trimester-wise nutrition support', 'Practical help for nausea and cravings', 'Nourishment for mother and baby'], image: 'https://images.unsplash.com/photo-1532094349884-543bc11b234d?auto=format&fit=crop&w=1200&q=85' },
  paediatric: { title: 'Paediatric Nutrition', subtitle: 'Growth-supporting meals that work even with picky eaters.', points: ['Growth-focused meal planning', 'Picky-eater friendly strategies', 'Family routines that feel achievable'], image: 'https://images.unsplash.com/photo-1503454537195-1dcabb73ffb9?auto=format&fit=crop&w=1200&q=85' },
  ...
  midlife: { title: 'Perimenopause & Menopause', subtitle: 'Nutrition for changing metabolism, muscle, bone and appetite through midlife.', points: ['Support for changing metabolism', 'Muscle and bone supportive meals', 'Appetite and energy strategies'], image: 'https://images.unsplash.com/photo-1515377905703-c4788e51af15?auto=format&fit=crop&w=1200&q=85' },
  lifestyle: { title: 'Lifestyle Counselling', subtitle: 'Habit building and accountability that outlast motivation.', points: ['Small, sustainable habit changes', 'Accountability that fits real life', 'Tools to build lasting consistency'], image: 'https://images.unsplash.com/photo-1506126613408-ecas07ce68773?auto=format&fit=crop&w=1200&q=85' },
};
