...
export const MYSTERY_STRATEGIES: Record<string, { title: string; subtitle: string; points: string[]; image?: string }> = {
  ...
  lifestyle: { title: 'Lifestyle Counselling', subtitle: 'Habit building and accountability that outlast motivation.', points: ['Small, sustainable habit changes', 'Accountability that fits real life', 'Tools to build lasting consistency'], image: '/images/dietitian-in-ludhiana.jpg' },
};
